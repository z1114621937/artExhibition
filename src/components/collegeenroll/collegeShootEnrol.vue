<template>
  <div class="home">
    ...
    <div class="homeContent">
      <div class="header">
        <span>摄影作品报名</span>
        <p>单张照和组照（每组不超过4幅，需标明顺序号）尺寸均为14英寸（30.48cm×35.56cm）；除影调处理外，不得利用电脑和暗房技术改变影像原貌。</p>
      </div>
      <!---表单-->
      <div class="fromBady">
        <el-form
        ...
        >
          <div class="right">
            <el-form-item label="作品名称" label-width="150px" prop="workname">
              <el-input v-model="form.workname" class="workwidth"  placeholder="请输入作品名称"></el-input>
            </el-form-item>
          </div>
          <div class="right">
            <el-form-item
        ...
        >
          <div class="left">
            <el-form-item label="上传作品" label-width="150px">
              <el-upload
                class="upload-demo"
                drag
              ...
              >
                ...
                <div class="el-upload__tip" slot="tip">
                 单张照尺寸均为14英寸（30.48cm×35.56cm）；除影调处理外，不得利用电脑和暗房技术改变影像原貌。作品的数码照片要求：JPG格式，大小不低于10M，分辨率达到300dpi
                </div>
              </el-upload>
            </el-form-item>
          </div>
