  ...
  <div class="home">
    ...
    <div class="nav">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size:16px">
        ...
        <el-breadcrumb-item>舞蹈作品报名</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 内容主体区 -->
         ...
         <div class="leftForm">
            <el-form-item label="表演形式" label-width="100px">
              <el-select v-model="form.layout" class="layoutWidth">
                <el-option label="群舞" value="群舞"></el-option>
              </el-select>
            </el-form-item>
          </div>
        ...
        >
          <div class="leftForm">
            <el-form-item label="作品名称" label-width="100px" prop="art">
              <el-input v-model="form.art" class="layoutWidth" placeholder="例：《舞蹈作品名》"></el-input>
            </el-form-item>
          </div>
