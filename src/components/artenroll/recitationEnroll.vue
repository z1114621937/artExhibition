  ...
  <div class="home">
    ...
    <div class="nav">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size:16px">
        ...
        <el-breadcrumb-item>朗诵作品报名</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 内容主体区 -->
    <div class="homeContent">
      <div class="header">
        <span>朗诵作品报名</span>
        <p>作品文体不限，须使用普通话，人数不超过8人（含伴奏，学生不作道具设置，不得伴舞），演出时间不超过5分钟。</p>
      </div>
      <!-- 表单区域 -->
      <div class="fromBady">
        <!-- 第一排 -->
         ...
         <div class="leftForm">
            <el-form-item label="表演形式" label-width="100px">
              <el-select v-model="form.layout" class="layoutWidth">
                <el-option label="朗诵" value="朗诵"></el-option>
              </el-select>
            </el-form-item>
          </div>
        ...
        >
          <div class="leftForm">
            <el-form-item label="作品名称" label-width="100px" prop="art">
              <el-input v-model="form.art" class="layoutWidth" placeholder="例：《朗诵作品》"></el-input>
            </el-form-item>
          </div>
