...
国画、水彩/水粉画（丙烯画）、版画、油画，或其他画种。尺寸：国画不超过四尺宣纸（69cm×138cm）对开，
其他画种尺寸均不超过对开（54cm×78cm）。</p>
      </div>
      <!-- 表单区域 -->
      <div class="fromBady">
        <!-- 第一排 -->
          ...
          <div class="rightForm">
            <el-form-item label="作品形式" label-width="100px">
              <el-select v-model="form.xingshi" class="layoutWidth">
                ...
                <el-option label="水彩/水粉画" value="水彩/水粉画"></el-option>
            ...
            <el-form-item label="上传作品" label-width="100px">
              ...
              >
                ...
                <div
                  ...
                  slot="tip"
                  style="width:800px"
                >请上传绘画作品数码照片，作品的数码照片要求：JPG格式，大小不低于10M，分辨率达到300dpi</div>
              </el-upload>
            </el-form-item>
          </div>
        </el-form>
