  ...
  <div class="home">
    ...
    <div class="nav">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size:16px">
        ...
        <el-breadcrumb-item>书法、篆刻作品报名</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 内容主体区 -->
    <div class="homeContent">
      <div class="header">
        <span>书法作品</span>
        <p>书法、篆刻作品尺寸不超过四尺宣纸（69cm×138cm）。<br>
          ...
          <div class="rightForm">
            <el-form-item label="作品形式" label-width="100px">
              <el-select v-model="form.xingshi" class="layoutWidth">
                ...
                <el-option label="篆刻" value="篆刻"></el-option>
              </el-select>
            </el-form-item>
          </div>
        </el-form>
            ...
            <el-form-item label="上传作品" label-width="100px">
              ...
              >
                ...
                <div
                  ...
                  slot="tip"
                  style="width:800px"
                >请上传书法作品数码照片，作品的数码照片要求：JPG格式，大小不低于10M，分辨率达到300dpi</div>
              </el-upload>
            </el-form-item>
          </div>
        </el-form>
