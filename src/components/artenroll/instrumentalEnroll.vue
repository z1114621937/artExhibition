  ...
  <div class="home">
    ...
    <div class="nav">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size:16px">
        ...
        <el-breadcrumb-item>器乐作品报名</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 内容主体区 -->
    <div class="homeContent">
      <div class="header">
        <span>器乐作品报名</span>
        <p>合奏：乐队人数不超过65人，指挥1人（鼓励本校教师担任），演出时间不超过9分钟，鼓励演奏中国作品。
小合奏或重奏：人数不超过12人，不设指挥，演出时间不超过6分钟。</p>
      </div>
      <!-- 表单区域 -->
      <div class="fromBady">
        <!-- 第一排 -->
         ...
         <div class="leftForm">
            <el-form-item label="表演形式" label-width="100px">
              <el-select v-model="form.layout" class="layoutWidth">
                ...
                <el-option label="小合奏" value="小合奏"></el-option>
                <el-option label="重奏" value="重奏"></el-option>
              </el-select>
            </el-form-item>
          </div>
        ...
        >
          <div class="leftForm">
            <el-form-item label="作品名称" label-width="100px" prop="art">
              <el-input v-model="form.art" class="layoutWidth" placeholder="例：《器乐作品名》"></el-input>
            </el-form-item>
          </div>
      ...
      <el-form rel="form" class="demo-form-inline" :inline="true">
        <div class="leftForm">
          <el-form-item label="指挥信息" label-width="100px">
