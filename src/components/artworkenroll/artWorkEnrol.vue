  ...
  <div class="home">
    ...
    <div class="nav">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>艺术实践工作坊</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!---主体-->
    <div class="homeContent">
      ...
      <div class="fromBady">
        ...
        >
          <div class="right">
            <el-form-item label="项目名称" label-width="150px" prop="itemname">
              <el-input v-model="form.itemname" class="workwidth" placeholder="请输入项目名称"></el-input>
            </el-form-item>
          </div>
          <div class="right">
            <el-form-item
              ...
              prop="username"
            >
              <el-input v-model="form.username" class="workwidth" placeholder="请输入联系人名字"></el-input>
            </el-form-item>
          </div>
        </el-form>
        <!---第二排-->
        ...
        >
          <div class="right">
            <el-form-item
              ...
              prop="userunit"
            >
              <el-input v-model="form.userunit" class="workwidth" placeholder="请输入联系人单位"></el-input>
            </el-form-item>
          </div>
          <div class="right">
            <el-form-item
              ...
              prop="useradress"
            >
              <el-input v-model="form.useradress" class="workwidth" placeholder="请输入联系人地址"></el-input>
            </el-form-item>
          </div>
        </el-form>
        <!--第三排-->
        ...
        >
          <div class="right">
            <el-form-item
              ...
              prop="userduty"
            >
              <el-input v-model="form.userduty" class="workwidth" placeholder="请输入联系人职务"></el-input>
            </el-form-item>
          </div>
          <div class="right">
            <el-form-item
              ...
              prop="email"
            >
              <el-input v-model="form.email" class="workwidth" placeholder="请输入电子邮箱"></el-input>
            </el-form-item>
          </div>
        </el-form>
        <!---第四排-->
        ...
        >
          <div class="right">
            <el-form-item
              ...
              prop="adress"
            >
              <el-input v-model="form.adress" class="workwidth" placeholder="请输入地址"></el-input>
            </el-form-item>
          </div>
          <div class="right" >
        ...
        >
          <div class="right">
            <el-form-item
              ...
              prop="joinnumber"
            >
              <el-input v-model="form.joinnumber" class="workwidth" placeholder="请输入参数人数"></el-input>
            </el-form-item>
          </div>
        </el-form>
        <!--第六排作者-->
        ...
        >
         <div class="right">
            <el-form-item label="工作坊项目介绍" label-width="150px" prop="induction">
              <el-input
                type="textarea"
                v-model="form.desc"
                style="width: 350px"
          ...
          <div class="right">
            <el-form-item label="设计思路和特色描述" label-width="150px" prop="descrinbe">
              <el-input
                type="textarea"
                v-model="form.desc"
                style="width: 350px"
        ...
        >
         <div class="right">
            <el-form-item label="展区设计方案" label-width="150px" prop="area">
              <el-input
                type="textarea"
                v-model="form.desc"
                style="width: 350px"
        ...
        >
          <div class="left">
            <el-form-item label="上传工作坊视频" label-width="150px">
              <el-upload
                class="upload-demo"
                drag
...
export default {
  data() {
    ...
    return {
      options: ["艺术与科技", "艺术与校园","艺术与生活","艺术与美丽乡村"],
      value: "",
      form: {
        itemname: "",
        username: "",
      ...
      rules: {
        itemname: [
          { required: true, message: "请输入项目作品名称", trigger: "blur" },
        ],
        workadress: [
        ...
        userduty: [
          ...
          joinnumber: [
          { required: true, message: "请输入参展人数", trigger: "blur" },
        ],
        induction: [
          { required: true, message: "请输入工作坊项目介绍", trigger: "blur" },
        ],
         descrinbe: [
          { required: true, message: "请输入设计思路和特色描述", trigger: "blur" },
        ],
         area: [
          { required: true, message: "请输入展区设计方案", trigger: "blur" },
        ],
         sort: [
