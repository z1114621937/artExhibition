  ...
  <div class="home">
    ...
    <div class="nav">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size:16px">
        ...
        <el-breadcrumb-item>微电影作品报名</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 内容主体区 -->
    ...
    片长不超过15分钟，视频统一采用MPG2格式，作者须保留MOV或AVI格式视频文件。</p>
      </div>
      <!-- 表单区域 -->
      <div class="fromBady">
        <!-- 第一排 -->
        ...
        <el-form rel="form" class="demo-form-inline" :inline="true" :rules="rules" :model="form">
           <div class="rightForm">
            <el-form-item label="视频时长" prop="min">
            ...
            <el-form-item label="上传作品" label-width="100px">
              ...
              >
                ...
                <div
                  ...
                  slot="tip"
                  style="width:800px"
                >请上传微电影视频（时长不超过15分钟，采用MPG2格式，文件大小不超过1.2G）</div>
              </el-upload>
            </el-form-item>
          </div>
        </el-form>
