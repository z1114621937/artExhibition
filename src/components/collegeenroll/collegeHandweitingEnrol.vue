  ...
  <div class="home">
    ...
    <div class="nav">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>书法，篆刻报名</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!---主体-->
    <div class="homeContent">
      <div class="header">
        <span>书法作品</span>
        <p>书法、篆刻作品尺寸不超过四尺宣纸（69cm×138cm）。</p>
      </div>
      <!---表单-->
      <div class="fromBady">
        <el-form
        ...
        >
          <div class="right">
            <el-form-item
              ...
              prop="workwidth"
            >
              <el-input v-model="form.workwidth" class="workwidth"  placeholder="请输入作品宽度"></el-input>
            </el-form-item>
          </div>
          <div class="right">
            ...
            <el-form-item label="上传图片" label-width="150px">
              ...
              >
                ...
                <div class="el-upload__tip" slot="tip">
                  请上传书法作品数码照片，作品的数码照片要求：JPG格式，大小不低于10M，分辨率达到300dpi
                </div>
              </el-upload>
            </el-form-item>
          </div>
